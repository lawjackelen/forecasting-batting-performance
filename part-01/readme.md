...
**Goal**: Host a lightning talk presentation describing *at least three* project proposals, including associated data, goals, audiences, and metrics.

---

## Requirements
Prepare a slide deck and host a 3-5 minute lightning talk on **at least three** potential topics for your DSI capstone project. For each topic, define **all** required areas:
...
#### BONUS
4. Beyond the three required topics, what other potential topics might you explore? (e.g. 3 or more)
